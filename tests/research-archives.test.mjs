...
test(
  "preserved 0.18.0 installers match the exact public release inventory",
  {
    skip:
      process.env.GROK_BOT_SOURCE_ONLY === "1"
        ? "source-only exports intentionally retain the signed inventory without installer payloads"
        : false,
  },
  async () => {
