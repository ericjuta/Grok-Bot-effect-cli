...
export const GATEWAY_SERVICE_CAPABILITIES = [
  "gatewayServicesV1",
  "mcpManagementV1",
...
export const SAND_GATEWAY_COMMANDS = {
  listGatewayServices: () => ({
    ...
    capabilities: GATEWAY_SERVICE_CAPABILITIES,
    methods: Object.keys(SAND_GATEWAY_COMMANDS).sort()
  }),
  ...
  getAuthStatus: (api: GatewayApi) => api.getAuthStatus(),
  getRuntimeStatus: (api: GatewayApi) => api.getRuntimeStatus(),
  listLocalComputers: (api: GatewayApi) => api.listLocalComputers(),
  getLocalToolPermissionStatus: (api: GatewayApi, body: string) => api.getLocalToolPermissionStatus(parseCommandArgs(body)),
  getSearchStatus: (api: GatewayApi) => api.getSearchStatus(),
  ...
  getAgentNotificationAvatar: (api: GatewayApi, body: string) => api.getAgentNotificationAvatar(parseCommandArgs(body)),
  ...
  getMcpState: (api: GatewayApi) => api.getMcpState(),
  getMcpCatalog: (api: GatewayApi) => api.getMcpCatalog(),
  getEffectiveMcpPlugins: (api: GatewayApi) => api.getEffectiveMcpPlugins(),
  getMcpPluginLogo: (api: GatewayApi, body: string) => api.getMcpPluginLogo(parseCommandArgs(body)),
  installMcpEntry: (api: GatewayApi, body: string) => api.installMcpEntry(parseCommandArgs(body)),
  updateMcpPluginInstall: (api: GatewayApi, body: string) => api.updateMcpPluginInstall(parseCommandArgs(body)),
  setMcpCustomInstructions: (api: GatewayApi, body: string) => api.setMcpCustomInstructions(parseCommandArgs(body)),
  ...
  transcribeAudio: (api: GatewayApi, body: string) => api.transcribeAudio(parseCommandArgs(body)),
  ...
  installMcpPlugin: (api: GatewayApi, body: string) => api.installMcpPlugin(parseCommandArgs(body)),
  uninstallMcpPlugin: (api: GatewayApi, body: string) => api.uninstallMcpPlugin(parseCommandArgs(body)),
  ...
  setMcpInstructions: (api: GatewayApi, body: string) => api.setMcpInstructions(parseCommandArgs(body)),
  restartMcpServers: (api: GatewayApi) => api.restartMcpServers(),
  authenticateMcpServer: (api: GatewayApi, body: string) => api.authenticateMcpServer(parseCommandArgs(body)),
  logoutMcpAccount: (api: GatewayApi, body: string) => api.logoutMcpAccount(parseCommandArgs(body)),
  renameMcpAccount: (api: GatewayApi, body: string) => api.renameMcpAccount(parseCommandArgs(body)),
  removeMcpAccount: (api: GatewayApi, body: string) => api.removeMcpAccount(parseCommandArgs(body)),
  ...
  listCloudAgents: (api: GatewayApi, body: string) => api.listCloudAgents(parseCommandArgs(body)),
  listCloudAgentModels: (api: GatewayApi) => api.listCloudAgentModels(),
  getCloudAgent: (api: GatewayApi, body: string) => api.getCloudAgent(parseCommandArgs(body)),
  launchCloudAgent: (api: GatewayApi, body: string) => api.launchCloudAgent(parseCommandArgs(body)),
  watchCloudAgent: (api: GatewayApi, body: string) => api.watchCloudAgent(parseCommandArgs(body)),
  replyToCloudAgent: (api: GatewayApi, body: string) => api.replyToCloudAgent(parseCommandArgs(body)),
  cancelCloudAgent: (api: GatewayApi, body: string) => api.cancelCloudAgent(parseCommandArgs(body)),
  renameCloudAgent: (api: GatewayApi, body: string) => api.renameCloudAgent(parseCommandArgs(body)),
  archiveCloudAgent: (api: GatewayApi, body: string) => api.archiveCloudAgent(parseCommandArgs(body)),
  unarchiveCloudAgent: (api: GatewayApi, body: string) => api.unarchiveCloudAgent(parseCommandArgs(body)),
  deleteCloudAgent: (api: GatewayApi, body: string) => api.deleteCloudAgent(parseCommandArgs(body)),
  listCloudAgentArtifacts: (api: GatewayApi, body: string) => api.listCloudAgentArtifacts(parseCommandArgs(body)),
  getCloudAgentTranscript: (api: GatewayApi, body: string) => api.getCloudAgentTranscript(parseCommandArgs(body))
};
